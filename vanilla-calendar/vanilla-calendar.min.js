...
!(function (e, t) {
  ...
  var e = Object.defineProperty,
    ...
    n = (t, a, s) =>
      a in t
        ...
        : (t[a] = s),
    l = (e, t, a) => (n(e, "symbol" != typeof t ? t + "" : t, a), a);
  const r = {
      ...
      dayBtnSelectedIntermediate:
        "vanilla-calendar-day__btn_selected_intermediate",
    ...
    constructor() {
      ...
      l(this, "isInit", !1),
        ...
        l(
          ...
          "CSSClasses",
          ((e, l) => {
            for (var r in l || (l = {})) a.call(l, r) && n(e, r, l[r]);
            if (t) for (var r of t(l)) s.call(l, r) && n(e, r, l[r]);
            return e;
          })({}, r)
        ),
        l(this, "DOMTemplates", {
          default:
            ((e = this.CSSClasses),
            `\n\t<div class="${e.header}">\n\t\t<#ArrowPrev />\n\t\t<div class="${e.headerContent}">\n\t\t\t<#Month />\n\t\t\t<#Year />\n\t\t</div>\n\t\t<#ArrowNext />\n\t</div>\n\t<div class="${e.wrapper}">\n\t\t<#WeekNumbers />\n\t\t<div class="${e.content}">\n\t\t\t<#Week />\n\t\t\t<#Days />\n\t\t</div>\n\t</div>\n\t<#ControlTime />\n`),
          multiple: i(this.CSSClasses),
          month: d(this.CSSClasses),
          year: c(this.CSSClasses),
        }),
        l(this, "HTMLElement"),
        l(this, "HTMLOriginalElement"),
        l(this, "HTMLInputElement"),
        l(this, "rangeMin"),
        l(this, "rangeMax"),
        l(this, "rangeDisabled"),
        l(this, "rangeEnabled"),
        l(this, "selectedDates"),
        l(this, "selectedHolidays"),
        l(this, "selectedMonth"),
        l(this, "selectedYear"),
        l(this, "selectedHours"),
        l(this, "selectedMinutes"),
        l(this, "selectedKeeping"),
        l(this, "selectedTime"),
        l(this, "userTime"),
        l(this, "currentType"),
        l(this, "correctMonths"),
        l(this, "viewYear"),
        l(this, "dateMin"),
        l(this, "dateMax");
    }
  ...
  const u = (e) =>
    ...
    h = 'Incorrect name of theme in "settings.visibility.theme".',
    y = "The value of the time property can be: false, true, 12 or 24.",
    v = (e) =>
          ...
          t.match(/^(\d{4}-\d{2}-\d{2})$/g)
            ...
            : t.replace(
                ...
                (t, a, s) => {
                  ...
                  for (; r <= l; r.setDate(r.getDate() + 1)) e.push(v(r));
                  return t;
                }
              ),
          e
      ...
      (e.currentType = e.type),
        ...
        ((e) => {
          ...
          (e.settings.range.min =
            M(e.date.min) >= M(e.settings.range.min)
              ? e.date.min
              : e.settings.range.min),
            (e.settings.range.max =
              M(e.date.max) <= M(e.settings.range.max)
                ? e.date.max
                : e.settings.range.max);
          const n =
            e.settings.range.disablePast &&
            !e.settings.range.disableAllDays &&
            M(e.settings.range.min) < e.date.today;
          (e.rangeMin = n
            ? v(e.date.today)
            : e.settings.range.disableAllDays
            ? v(new Date(e.selectedYear, e.selectedMonth, 1))
            : e.settings.range.min),
            (e.rangeMax = e.settings.range.disableAllDays
              ? v(new Date(e.selectedYear, e.selectedMonth, 1))
              : e.settings.range.max);
          const l = M(e.rangeMin),
            r = M(e.rangeMax);
          if (
            (l.setDate(l.getDate() - 1),
            r.setDate(r.getDate() + 1),
            (e.rangeDisabled = e.settings.range.disabled
              ? S(e.settings.range.disabled)
              : []),
            e.settings.range.disableAllDays)
          ) {
            const t = new Date(
            ...
            for (let a = 1; a <= t; a++)
              e.rangeDisabled.push(
                v(new Date(e.selectedYear, e.selectedMonth, a))
              );
          }
          e.rangeDisabled.push(v(l)),
            e.rangeDisabled.push(v(r)),
            e.rangeDisabled.sort((e, t) => +new Date(e) - +new Date(t)),
            (e.rangeEnabled = e.settings.range.enabled
              ? S(e.settings.range.enabled)
              : []),
            (null == (t = e.rangeEnabled) ? void 0 : t[0]) &&
              (e.rangeDisabled =
                null == (a = e.rangeDisabled)
                  ? void 0
                  : a.filter((t) => {
                      var a;
                      return !(null == (a = e.rangeEnabled)
                        ? void 0
                        : a.includes(t));
                    })),
        ...
        ((e) => {
          ...
          (e.selectedDates = (
            ...
            ? S(e.settings.selected.dates)
            : []),
            (e.selectedHolidays = (
              null == (a = e.settings.selected.holidays) ? void 0 : a[0]
            )
              ? S(e.settings.selected.holidays)
              : []);
        })(e),
        ((e) => {
        ...
        ((e) => {
          ...
          if (t || 24 === e.settings.selection.time) {
            if (
              ((e.userTime = !1), "string" == typeof e.settings.selected.time)
            ) {
              const a = t
            ...
            !e.userTime && t
              ? ((e.selectedHours = p(String(e.date.today.getHours()))),
          ...
          } else if (e.settings.selection.time) throw new Error(y);
        })(e),
        ((e) => {
          e.correctMonths =
            "multiple" === e.type
    ...
    f = (e, t) => {
      ...
      e.locale.weekday.push(b(a));
    },
    w = (e, t) => {
      const a = new Date(0, t).toLocaleString(e.settings.lang, {
        month: "long",
      });
      e.locale.months.push(b(a));
    },
    D = ({ arrowPrev: e, arrowNext: t, isPrevHidden: a, isNextHidden: s }) => {
    ...
    T = (e) => {
      ...
      ({
        default: () => {
          const t = M(v(new Date(e.selectedYear, e.selectedMonth, 1))),
          ...
          D({ arrowPrev: s, arrowNext: n, isPrevHidden: r, isNextHidden: i });
        },
        year: () => {
          D({
            arrowPrev: s,
    ...
    $ = (e, t) => {
      if (!e) return null;
      const a = M(e),
        s = t ? a.getDay() || 7 : a.getDay();
      a.setDate(a.getDate() + 4 - s);
      const n = new Date(a.getFullYear(), 0, 1),
        l = Math.ceil(((+a - +n) / 864e5 + 1) / 7);
      return { year: a.getFullYear(), week: l };
    },
    L = (e, t, a, s, n) => {
      const l = t[a].querySelector(`.${e.CSSClasses.dayBtn}`),
        r = $(null == l ? void 0 : l.dataset.calendarDay, e.settings.iso8601);
      if (!r) return;
    ...
    H = (e, t, a, s, n, l, r, i) => {
      ...
      (c.className = `${e.CSSClasses.dayBtn}${i ? ` ${i}` : ""}`),
        (c.type = "button"),
        (c.innerText = String(s)),
        (c.dataset.calendarDay = l);
      e.settings.visibility.weekNumbers &&
        (() => {
          const t = $(l, e.settings.iso8601);
          t && (c.dataset.calendarWeekNumber = String(t.week));
        })(),
        r ? e.settings.visibility.daysOutside && d.append(c) : d.append(c),
        ((e, t, a) => {
          var s, n, l;
          (null == (s = e.settings.range.disableWeekday)
            ? void 0
            : s.includes(a)) &&
            !(null == (n = e.rangeDisabled) ? void 0 : n.includes(t)) &&
            ((e.rangeDisabled = e.rangeDisabled
              ? [...e.rangeDisabled, t]
              : [t]),
            null == (l = e.rangeDisabled) ||
        ...
        ((e, t, a, s, n, l, r) => {
          ...
          (M(e.rangeMin) > M(l) ||
            ...
            (!e.settings.selection.year && M(l).getFullYear() !== t)) &&
            (s.classList.add(e.CSSClasses.dayBtnDisabled), (s.tabIndex = -1)),
            e.settings.visibility.today &&
              v(e.date.today) === l &&
              s.classList.add(e.CSSClasses.dayBtnToday),
            !e.settings.visibility.weekend ||
              (0 !== n && 6 !== n) ||
              s.classList.add(e.CSSClasses.dayBtnWeekend),
            (null == (d = e.selectedHolidays) ? void 0 : d.includes(l)) &&
              s.classList.add(e.CSSClasses.dayBtnHoliday),
            (null == (c = e.selectedDates) ? void 0 : c.includes(l)) &&
              (a.classList.add(e.CSSClasses.daySelected),
              ...
              e.selectedDates.length > 1 &&
                ...
                (e.selectedDates[0] === l
                  ? (a.classList.add(e.CSSClasses.daySelectedFirst),
                    s.classList.add(e.CSSClasses.daySelectedFirst))
                  : e.selectedDates[e.selectedDates.length - 1] === l
                  ? (a.classList.add(e.CSSClasses.daySelectedLast),
                    s.classList.add(e.CSSClasses.dayBtnSelectedLast))
                  : (a.classList.add(e.CSSClasses.daySelectedIntermediate),
                    s.classList.add(e.CSSClasses.dayBtnSelectedIntermediate))));
        })(e, t, d, c, n, l, r),
        a.append(d),
        e.actions.getDays && e.actions.getDays(s, l, d, c);
    },
    E = (e) => {
      const t = e.HTMLElement.querySelectorAll(`.${e.CSSClasses.days}`),
        a = e.HTMLElement.querySelectorAll(`.${e.CSSClasses.weekNumbers}`),
        s = new Date(e.selectedYear, e.selectedMonth, 1);
      t.forEach((t, n) => {
        const l = new Date(s);
        l.setMonth(l.getMonth() + n);
        const r = l.getMonth(),
          i = l.getFullYear(),
          d = new Date(i, r, 1),
        ...
        e.settings.selection.day && t.classList.add(e.CSSClasses.daysSelecting),
          (t.innerHTML = ""),
          ((e, t, a, s, n) => {
            let l = new Date(a, s, 0).getDate() - (n - 1);
            const r = 0 === s ? a - 1 : a,
              i = 0 === s ? 12 : s < 10 ? `0${s}` : s;
            for (let d = n; d > 0; d--, l++) {
              const s = `${r}-${i}-${l}`,
                n = M(s).getDay();
              H(e, a, t, l, n, s, !0, e.CSSClasses.dayBtnPrev);
            }
          })(e, t, i, r, o),
          ((e, t, a, s, n) => {
            for (let l = 1; l <= a; l++) {
              const a = new Date(s, n, l),
                r = v(a),
                i = a.getDay();
              H(e, s, t, l, i, r, !1, null);
            }
          })(e, t, c, i, r),
          ((e, t, a, s, n, l) => {
            const r = l + a,
              i = 7 * Math.ceil(r / 7) - r,
              d = n + 1 === 12 ? s + 1 : s,
              c = n + 1 === 12 ? "01" : n + 2 < 10 ? `0${n + 2}` : n + 2;
            for (let o = 1; o <= i; o++) {
              const a = `${d}-${c}-${o < 10 ? `0${o}` : String(o)}`,
                n = M(a).getDay();
              H(e, s, t, o, n, a, !0, e.CSSClasses.dayBtnNext);
            }
          })(e, t, c, i, r, o),
          ((e, t, a, s, n) => {
            ...
            const d = n.querySelectorAll(`.${e.CSSClasses.day}`),
              c = Math.ceil((t + a) / 7);
            for (let o = 0; o < c; o++) L(e, d, 0 === o ? 6 : 7 * o, i, r);
          })(e, o, c, a[n], t),
          ((e, t) => {
            var a;
            e.popups &&
              (null == (a = Object.entries(e.popups)) ||
                a.forEach(([a, s]) =>
                  ((e, t, a, s) => {
                    const n = a.querySelector(`[data-calendar-day="${e}"]`);
                    n &&
                      ((null == t ? void 0 : t.modifier) &&
                        n.classList.add(...t.modifier.trim().split(" ")),
                      (null == t ? void 0 : t.html) &&
                        (n.parentNode.innerHTML += `<div class="${s}">${t.html}</div>`));
                  })(a, s, t, e.CSSClasses.dayPopup)
                ));
          })(e, t);
      });
    },
    ...
    k = (e, t) => {
      const {
        ...
        d = (n, l) => {
          if (!t) return;
          const r = a.querySelector(`.${s.controls}`);
          r && a.removeChild(r);
          a.querySelector(`.${s.grid}`).classList.add(s.gridDisabled);
          const i = t.closest(`.${s.column}`);
          i.classList.add(n), (i.innerHTML = _(e, l));
        },
        c = {
          default: () => {
            a.classList.add(s.calendarDefault),
              a.classList.remove(s.calendarMonth, s.calendarYear),
              (a.innerHTML = _(e, n.default));
          },
          multiple: () => {
            i &&
              (a.classList.add(s.calendarMultiple),
              a.classList.remove(s.calendarMonth, s.calendarYear),
              (a.innerHTML = ((e, t) =>
                t
                  .replace(/<#Multiple>(.*?)<#\/Multiple>/g, (t, a) => {
                    let s = "";
                    for (let n = 0; n < e.correctMonths; n++) s += a;
                    return s;
                  })
                  .replace(/[\n\t]/g, ""))(e, _(e, n.multiple))));
          },
          month: () => {
            "multiple" !== l
              ? (a.classList.add(s.calendarMonth),
                a.classList.remove(s.calendarDefault, s.calendarYear),
                (a.innerHTML = _(e, n.month)))
              : d(s.columnMonth, n.month);
          },
          year: () => {
            "multiple" !== l
              ? (a.classList.add(s.calendarYear),
                a.classList.remove(s.calendarDefault, s.calendarMonth),
                (a.innerHTML = _(e, n.year)))
              : d(s.columnYear, n.year);
          },
        };
      a.classList.add(s.calendar), c[r]();
    },
    x = (e) => {
      var t, a;
      const s =
      ...
      if (!(null == s ? void 0 : s[0]) && (null == n ? void 0 : n[0])) return;
        ...
        s.forEach((t, a) =>
          ((e, t, a, s) => {
            ...
            (t.tabIndex = l ? -1 : 0),
              ...
              t.setAttribute("data-calendar-selected-month", String(n)),
              (t.innerText = e.locale.months[n]);
          })(e, t, a, l)
        ),
        null == n ||
          n.forEach((t, a) =>
            ((e, t, a, s) => {
              const n = new Date(
                  s.setFullYear(e.selectedYear, e.selectedMonth + a)
                ).getFullYear(),
                l =
              ...
              (t.tabIndex = l ? -1 : 0),
                ...
                t.setAttribute("data-calendar-selected-year", String(n)),
    ...
    A = (e, t, a, s, n, l) => {
      ...
      return (
        ...
        (r.title = s),
        (r.innerText = `${
          e.settings.visibility.monthShort ? s.substring(0, 3) : s
        }`),
    ...
    P = (e, t) => {
      var a, s;
      const n = (null == t ? void 0 : t.dataset.calendarSelectedMonth)
      ...
      (e.currentType = "month"), k(e, t), x(e);
      const i =
        null == (s = e.HTMLElement)
          ? void 0
          : s.querySelector(`.${e.CSSClasses.months}`);
      if (!e.settings.selection.month || !i) return;
      i.classList.add(e.CSSClasses.monthsSelecting);
      const d =
          e.jumpMonths > 1
            ? e.locale.months
                .map((t, a) => n - e.jumpMonths * a)
                .concat(e.locale.months.map((t, a) => n + e.jumpMonths * a))
                .filter((e) => e >= 0 && e <= 12)
            : Array.from(Array(12).keys()),
        c = document.createElement("button");
      c.type = "button";
      for (let o = 0; o < 12; o++) {
        const t = e.locale.months[o],
          a =
            (o < e.dateMin.getMonth() + N(e) && r <= e.dateMin.getFullYear()) ||
            (o > e.dateMax.getMonth() + N(e) && r >= e.dateMax.getFullYear()) ||
            (o !== n && !d.includes(o));
        i.append(A(e, c, n, t, a, o));
      }
    },
    F = (e, t) =>
      e && t
    ...
    I = (e) => ({
      hide() {
        e.HTMLElement.classList.add(e.CSSClasses.calendarHidden),
          e.actions.hideCalendar &&
            e.actions.hideCalendar(e.HTMLInputElement, e.HTMLElement);
      },
      show() {
        e.HTMLElement.classList.remove(e.CSSClasses.calendarHidden),
          e.actions.showCalendar &&
            e.actions.showCalendar(e.HTMLInputElement, e.HTMLElement);
      },
      HTMLInputElement: e.HTMLInputElement,
      HTMLElement: e.HTMLElement,
    }),
    B = (e, t, a) => e.querySelector(`.${t}${a ? ` input[name="${a}"]` : ""}`),
    q = (e, t, a) => {
    ...
    W = (e, t, a, s, n, l) => {
      t.addEventListener("input", (t) => {
        const r = t.target,
          i = Number(r.value),
          d = i < 10 ? `0${i}` : `${i}`;
        if ("hours" !== n || 12 !== l) return (a.value = d), void K(e, t, d, n);
        i < l && i > 0
          ? ((a.value = d),
            ...
            K(e, t, d, n))
          : (0 === i
              ? ((e.selectedKeeping = "AM"), (s.innerText = "AM"))
              : ((e.selectedKeeping = "PM"), (s.innerText = "PM")),
            (a.value = p(r.value)),
            K(e, t, p(r.value), n));
      });
    },
    O = (e, t, a, s, n, l) => {
      a.addEventListener("change", (a) => {
        ...
        "hours" === n && 12 === l
          ...
          : r.value && i <= l && i >= 0
          ? ((r.value = d), (t.value = d), K(e, a, d, n))
          : "hours" === n
          ? (r.value = e.selectedHours)
          : "minutes" === n && (r.value = e.selectedMinutes);
      });
    },
    j = (e, t, a) => {
      const s = 24 === a ? 23 : a || 12,
        n = B(t, e.CSSClasses.timeRange, "hours"),
        l = B(t, e.CSSClasses.timeRange, "minutes"),
        r = B(t, e.CSSClasses.timeHours, "hours"),
        i = B(t, e.CSSClasses.timeMinutes, "minutes"),
        d = t.querySelector(`.${e.CSSClasses.timeKeeping}`);
      q(n, r, e.CSSClasses.isFocus),
        q(l, i, e.CSSClasses.isFocus),
        W(e, n, r, d, "hours", s),
        W(e, l, i, d, "minutes", 0),
        O(e, n, r, d, "hours", s),
        O(e, l, i, d, "minutes", 59),
        d &&
          ((e, t, a) => {
            t.addEventListener("click", (s) => {
              (e.selectedKeeping = t.innerText.includes("AM") ? "PM" : "AM"),
                (t.innerText = e.selectedKeeping),
                (a.value = F(e.selectedHours, e.selectedKeeping)),
                K(e, s, e.selectedHours, "hours");
            });
          })(e, d, n);
    },
    R = (e, t, a, s) =>
    ...
    V = (e, t, a, s, n) => {
      ...
      return (
        ...
        (l.dataset.calendarYear = String(n)),
        (l.title = String(n)),
        (l.innerText = String(n)),
        s && (l.tabIndex = -1),
        l
      );
    },
    U = (e, t) => {
      const a = (null == t ? void 0 : t.dataset.calendarSelectedYear)
        ...
        : e.selectedYear;
      (e.currentType = "year"), k(e, t), x(e), T(e);
      const s = e.HTMLElement.querySelector(`.${e.CSSClasses.years}`);
      if (!e.settings.selection.year || !s) return;
      s.classList.add(e.CSSClasses.yearsSelecting);
      const n = "multiple" !== e.type || e.selectedYear === a ? 0 : 1,
        l = document.createElement("button");
      l.type = "button";
      for (let r = e.viewYear - 7; r < e.viewYear + 8; r++) {
        const t =
          r < e.dateMin.getFullYear() + n || r > e.dateMax.getFullYear();
        s.append(V(e, l, a, t, r));
      }
    },
    J = ["light", "dark", "system"],
    Q = {
    ...
    X = (e, t) =>
      J.find((a) => {
        ...
        return (
          "system" !== a &&
          (null == (s = e.getAttribute(t)) ? void 0 : s.includes(a))
        );
      }),
    Z = (e, t) => {
    ...
    ee = (e, t) => {
      const a = (t) => Z(e.HTMLElement, t.matches ? "dark" : "light");
      a(t),
        "system" !== e.settings.visibility.theme ||
          Q.check() ||
          (t.addEventListener("change", a), Q.set());
    },
    te = (e, t) => {
      const a = e.settings.visibility.themeDetect
        ...
        : null;
      if (a) {
        const s = e.settings.visibility.themeDetect.replace(
            /^.*\[(.+)\]/g,
            (e, t) => t
          ),
          n = X(a, s);
    ...
    ae = (e) => {
      ...
      ((e) => {
        if (!J.includes(e.settings.visibility.theme)) throw new Error(h);
        let t;
        if ("not all" === window.matchMedia("(prefers-color-scheme)").media)
          return void Z(e.HTMLElement, "light");
        (t = window.matchMedia("(prefers-color-scheme: dark)")),
          {
            light: () => Z(e.HTMLElement, "light"),
            dark: () => Z(e.HTMLElement, "dark"),
            system: () => te(e, t),
        ...
        ((e) => {
          if (
            ...
            if ("define" === e.settings.lang) throw new Error(g);
            (e.locale.weekday = []), (e.locale.months = []);
            for (let t = 0; t < 7; t++) f(e, t);
            for (let t = 0; t < 12; t++) w(e, t);
          }
        })(e),
        k(e),
        x(e),
        ...
        ((e) => {
          ...
          (t.innerHTML = `\n\t\t<div class="${
            ...
            e.selectedKeeping
              ? F(e.selectedHours, e.selectedKeeping)
              : e.selectedHours
          )}\n\t\t\t${G(
            "minutes",
            e.CSSClasses.timeRange,
    ...
    ne = (e, t) => {
      const a = M(v(new Date(e.selectedYear, e.selectedMonth, 1)));
      ({
    ...
    le = { self: null, rangeMin: void 0, rangeMax: void 0 },
    re = (e) => {
      var t, a, s;
      if (!(null == (t = le.self) ? void 0 : t.selectedDates)) return;
      const n = v(e);
      if (null == (a = le.self.rangeDisabled) ? void 0 : a.includes(n)) return;
      const l =
        null == (s = le.self.HTMLElement)
          ? void 0
          : s.querySelectorAll(`[data-calendar-day="${n}"]`);
      null == l ||
        l.forEach((e) => e.classList.add(le.self.CSSClasses.dayBtnHover));
    },
    ie = (e) => {
      var t;
      if (!e.target || !(null == (t = le.self) ? void 0 : t.selectedDates))
        return;
      (() => {
        var e, t;
        const a =
          null == (t = null == (e = le.self) ? void 0 : e.HTMLElement)
            ? void 0
            : t.querySelectorAll(`.${le.self.CSSClasses.dayBtnHover}`);
        null == a ||
          a.forEach((e) => e.classList.remove(le.self.CSSClasses.dayBtnHover));
      })();
      const a = e.target.closest("[data-calendar-day]");
      if (!a) return;
      const s = a.dataset.calendarDay,
        n = M(le.self.selectedDates[0]),
        l = M(s),
        [r, i] = n < l ? [n, l] : [l, n];
      for (let d = new Date(r); d <= i; d.setDate(d.getDate() + 1)) re(d);
    },
    de = (e) => {
      le.self &&
        "Escape" === e.key &&
        ((le.self.selectedDates = []),
        le.self.HTMLElement.removeEventListener("mousemove", ie),
        document.removeEventListener("keydown", de),
        ae(le.self));
    },
    ce = (e, t) => {
      const a = t.dataset.calendarDay,
        s = 1 === e.selectedDates.length && e.selectedDates[0].includes(a);
      (e.selectedDates = s
        ? []
        : e.selectedDates.length > 1
        ? [a]
        ...
        e.settings.range.disableGaps &&
          ((le.rangeMin = le.rangeMin ? le.rangeMin : e.rangeMin),
          (le.rangeMax = le.rangeMax ? le.rangeMax : e.rangeMax)),
        (le.self = e);
      ({
        set: () => {
          e.HTMLElement.addEventListener("mousemove", ie),
            ...
            e.settings.range.disableGaps &&
              (() => {
                ...
                if (
                  !(null ==
                  (t = null == (e = le.self) ? void 0 : e.selectedDates)
                    ? void 0
                    : t[0]) ||
                  !le.self.rangeDisabled ||
                  (null == (a = le.self.rangeDisabled) ? void 0 : a.length) < 2
                )
                  return;
                const s = M(le.self.selectedDates[0]),
                  [n, l] = le.self.rangeDisabled
                    .map((e) => M(e))
                    .reduce(
                      ([e, t], a) => [
                        s >= a ? a : e,
                ...
                n &&
                  (le.self.rangeMin = v(new Date(n.setDate(n.getDate() + 1)))),
                  l &&
                    (le.self.rangeMax = v(
        ...
        reset: () => {
          var t;
          const [a, s] = e.selectedDates.map((e) => M(e)),
            n = s > a ? 1 : -1;
          e.selectedDates = [];
          for (
            let l = new Date(a);
            ...
            const a = v(l);
            (null == (t = e.rangeDisabled) ? void 0 : t.includes(a)) ||
              (e.selectedDates = e.selectedDates
                ? [...e.selectedDates, a]
                : [a]);
          }
          e.HTMLElement.removeEventListener("mousemove", ie),
            ...
            e.settings.range.disableGaps &&
              le.self &&
              ((le.self.rangeMin = le.rangeMin),
              (le.self.rangeMax = le.rangeMax));
        },
    ...
    oe = (e, t, a) => {
      ...
      const s = t.dataset.calendarDay,
        n = t.classList.contains(e.CSSClasses.dayBtnSelected);
      e.selectedDates = n
        ? e.selectedDates.filter((e) => e !== s)
        : a
        ? [...e.selectedDates, s]
        : [s];
    },
    ue = (e, t, a, s, n) => {
      const l = e.HTMLElement.querySelectorAll(`.${e.CSSClasses.column}`),
        ...
        i = Number(l[r].querySelector(`.${a}`).getAttribute(n));
        ...
        i
          ? ((e, t, a, s, n) => {
              const l = {
                year: () => {
                  var a, s;
                  return null == (s = (a = e.actions).clickYear)
                    ? void 0
                    : s.call(a, t, e.selectedYear, e.selectedMonth);
                },
                month: () => {
                  var a, s;
                  return null == (s = (a = e.actions).clickMonth)
                    ? void 0
                    : s.call(a, t, e.selectedMonth, e.selectedYear);
                },
              };
              ({
                year: () => {
                ...
                month: () => {
                  if ("multiple" === e.type) {
                    const t = ue(
                        ...
                        e.CSSClasses.month,
                        Number(n.dataset.calendarMonth),
                        "data-calendar-selected-month"
                      ),
                      a = n
                        .closest(`.${s.column}`)
                    ...
                    e.selectedMonth = l
                      ...
                      ? e.dateMax.getMonth()
                      : t;
                  } else e.selectedMonth = Number(n.dataset.calendarMonth);
                },
              })[a](),
                l[a](),
                (e.currentType = e.type),
          ...
          : ((e.currentType === a && r) ||
              ("multiple" === e.type && e.currentType === a && d && !c)) &&
            ((e.currentType = e.type), ae(e));
    },
    ge = (e) => {
        ...
        ((e, t) => {
          ...
          a &&
            ...
            e.actions.clickArrow &&
              e.actions.clickArrow(t, e.selectedYear, e.selectedMonth));
        })(e, t),
          ((e, t) => {
            var a;
            if (
              ...
              return;
            const s = t.target.closest(`.${e.CSSClasses.weekNumber}`),
              n =
                null == (a = e.HTMLElement)
                  ? void 0
                  : a.querySelectorAll("[data-calendar-week-number]");
            if (!s || !n) return;
            const l = Number(s.innerText),
              r = Number(s.dataset.calendarYearWeek),
              i = [...n].filter(
                (e) => Number(e.dataset.calendarWeekNumber) === l
              );
            e.actions.clickWeekNumber(t, l, i, r);
          })(e, t),
          ((e, t) => {
            var a;
            const s = t.target,
              n = (e) => s.closest(`.${e}`),
              l = n(e.CSSClasses.dayBtn);
            if (
            ...
            const r = n(e.CSSClasses.dayBtnPrev),
              i = n(e.CSSClasses.dayBtnNext);
            ({
              prev: () => ne(e, "prev"),
              next: () => ne(e, "next"),
              default: () => E(e),
    ...
    he = (e, t) => {
      ...
      for (let n = e; n; n = n.offsetParent)
        (a += n.offsetTop || 0), (s += n.offsetLeft || 0);
      Object.assign(t.style, { left: `${s}px`, top: `${a}px` });
    },
    ye = (e) => {
      let t = !0;
      ...
      const a = (t) => {
        ...
        e &&
          ...
          !(null == (s = e.HTMLElement) ? void 0 : s.contains(t.target)) &&
          (e.HTMLInputElement && e.HTMLElement && I(e).hide(),
        ...
        t
          ? (() => {
              ...
              (a.className = `${e.CSSClasses.calendar} ${e.CSSClasses.calendarToInput} ${e.CSSClasses.calendarHidden}`),
                he(e.HTMLInputElement, a),
                (e.HTMLElement = a),
                document.body.append(e.HTMLElement),
                (t = !1),
                setTimeout(() => I(e).show(), 0),
                se(e),
                ge(e);
            })()
          : (he(e.HTMLInputElement, e.HTMLElement), I(e).show()),
  ...
  return class extends o {
    constructor(e, t) {
      if (
        (super(),
        l(this, "reset", () => se(this)),
        l(this, "update", () =>
          ((e) => {
            if (!e.isInit) throw new Error(m);
            const { dates: t, month: a, year: s } = e.settings.selected;
            (e.settings.selected.dates = (null == t ? void 0 : t[0])
              ? t
              : e.selectedDates),
              (e.settings.selected.month = a || e.selectedMonth),
              (e.settings.selected.year = s || e.selectedYear),
              C(e),
              ae(e),
              (e.settings.selected = { dates: t, month: a, year: s });
          })(this)
        ),
        l(this, "init", () => {
          return (
            ...
            (e.isInit = !0),
            void (e.input ? ye(e) : (C(e), ae(e), ge(e)))
          );
          var e;
        }),
        l(this, "destroy", () =>
          ((e) => {
            ...
            e.input
              ? (null ==
                  (a = null == (t = e.HTMLElement) ? void 0 : t.parentNode) ||
                  a.removeChild(e.HTMLElement),
                null == (s = e.HTMLInputElement) ||
